...
class EurekaReward():
    ...
    def compute_reward(self):
        ...
        smoothness_weight = 0.05  # Softer penalty for smoother actions
        ...
        # Compute scores & apply softening functions as needed
        velocity_score = velocity_weight * torch.exp(-0.5 * velocity_error)
        z_pos_score = z_pos_weight * (1 - z_pos_error)
