    def compute_reward(self):
        ...
        # Adjusted weights
        velocity_weight = 0.75  # Reduced to balance contribution
        z_pos_weight = 0.25     # Adjusted for importance of maintaining height
        orientation_weight = 0.1  # Slight reduction to balance with other factors
        dof_limit_penalty_weight = 0.05  # Maintained effectiveness
        smoothness_weight = 0.005  # Reduced to prevent over-penalization
        ...
        # Rewards calculation with rescaling
